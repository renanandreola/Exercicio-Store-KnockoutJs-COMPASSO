...
//function AppViewModel() {
  ...
  //data-bind - text - show words
function AppViewModel() {
  this.userName = ko.observable("Digite seu nome");
  this.userLastName = ko.observable("Digite seu sobrenome");
  this.userEmail = ko.observable("Digite seu email");
  this.userPhone = ko.observable("Digite seu fone")
